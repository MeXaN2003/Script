...
set desiredAoA to -15.
set P_gain to 0.9.        // усиление: градусы коррекции на градус ошибки
set D_gain to 0.6.       // усиление: градусы коррекции на градус ошибки
set deadband to 0.2.      // мёртвая зона, градусы
set maxPitchRate to 1.  // макс. изменение pitch за одну итерацию
set minPitch to 50.       // минимально допустимый тангаж
...
set prevTimeGravity to missionTime.
...
until phase = "DONE" {
    ...
    if phase = "LIFTOFF" {
        ...
        if ship:altitude < DangAlt and missionTime - prevTimeGravity >= 0.5 {
            set prevTimeGravity to missionTime.
